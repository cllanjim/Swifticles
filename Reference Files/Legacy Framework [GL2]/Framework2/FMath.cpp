...
FVec2 fmath_pivotPoint(FVec2 pPoint, float pDegrees, FVec2 pCenter, float pScale)
{
    FVec2 aReturn;
...
FVec2 fmath_pivotPoint(FVec2 pPoint, float pDegrees)
{
    return fmath_pivotPoint(pPoint, pDegrees, FVec2(0,0), 1.0f);
}
