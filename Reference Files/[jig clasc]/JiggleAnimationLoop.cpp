...
JiggleAnimationLoop::JiggleAnimationLoop()
{
...
void JiggleAnimationLoop::Update()
{
    
}

void JiggleAnimationLoop::Draw(float pCenterX, float pCenterY)
{
    
    Graphics::SetColor(1.0f, 0.25f, 0.15f, 0.65f);
    Graphics::OutlineRect(pCenterX - 6, pCenterY - 6, 12, 12, 4);
    
    
    Graphics::SetColor(0.0f, 0.25f, 0.33f);
    
    float aX2 = pCenterX + mOffsetX * 4.0f;
    float aY2 = pCenterY + mOffsetY * 4.0f;
    
    
    Graphics::DrawLine(pCenterX, pCenterY, aX2, aY2, 4);
...
void JiggleAnimationLoop::DrawGuide(float pCenterX, float pCenterY)
{
...
void JiggleAnimationLoop::AnimationUpdate(int pTick, int pTime)
{
...
void JiggleAnimationLoop::AnimationRefresh(int pTick, int pTime)
{
...
void JiggleAnimationLoop::AnimationCancel()
{
